# Generated by Django 4.1.2 on 2023-02-09 05:09
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location', models.CharField(choices=[('Banke', 'Banke'), ('Bagmati', 'Bagmati'), ('Bheri', 'Bheri'), ('Dhawalagiri', 'Dhawalagiri'), ('Gandaki ', 'Gandaki'), ('Janakpur ', 'Janakpur '), ('Karnali', 'Karnali'), ('koshi', 'koshi'), ('Lumbini', 'Lumbini'), ('Mahakali', 'Mahakali'), ('Mechi', 'Mechi'), ('Narayani', 'Narayani'), ('Rapti', 'Rapti'), ('Sagarmatha', 'Sagarmatha'), ('seti', 'seti')], max_length=50)),
